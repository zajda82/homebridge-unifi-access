...
export const featureOptions: { [index: string]: AccessFeatureOption[] } = {
  ...
  "Hub": [
    ...
    { default: false, description: "Control the door using UniFi Access lock rules. Unlocking applies a keep-unlocked rule and locking resets the rule. This overrides the lock delay interval.", modelKey: [ "UA Ultra", "UA Hub", "UA Hub Door Mini" ], name: "Door.UseLockRule" },
